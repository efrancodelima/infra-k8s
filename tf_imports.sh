...
# Importa a VPC
VPC_ID=$(./get_first_vpc_id.sh "lanchonete-vpc") 
...
# Importa as subnets
PUBLIC_SUBNET_0_ID=$(./get_first_subnet_id.sh "lanchonete-public-subnet-0") 
PUBLIC_SUBNET_1_ID=$(./get_first_subnet_id.sh "lanchonete-public-subnet-1") 
PRIVATE_SUBNET_0_ID=$(./get_first_subnet_id.sh "lanchonete-private-subnet-0") 
PRIVATE_SUBNET_1_ID=$(./get_first_subnet_id.sh "lanchonete-private-subnet-1")
